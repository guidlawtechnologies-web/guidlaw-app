      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '16px', color: 'rgba(232,235,240,0.6)', lineHeight: '1.7', maxWidth: '680px' }}>
            RoadRight connects Ontario drivers to LSO-licensed lawyers and paralegals via live video the moment they&apos;re pulled over.
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '12px' }}>
            {[
              { num: '01', text: <><strong>You toggle Available</strong> on the RoadRight lawyer app whenever you&apos;re ready to take calls — morning, evening, weekends, whenever fits.</> },
              { num: '02', text: <><strong>A driver is pulled over</strong> and presses one button. RoadRight connects them to you in seconds via live video.</> },
        ...
        <div style={{ background: 'rgba(59,130,246,0.05)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: '16px', padding: '22px 24px', marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(232,235,240,0.65)', lineHeight: '1.7' }}>
            Highway Traffic Act and Provincial Offences Act matters are squarely within the <strong style={{ color: '#E8EBF0' }}>P1 paralegal scope of practice</strong>. If HTA work is already part of your practice, RoadRight is a natural fit — same work, new channel, zero disruption to your existing caseload.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <div style={{ background: 'rgba(16,185,129,0.04)', border: '1px solid rgba(16,185,129,0.15)', borderRadius: '16px', padding: '22px 24px', display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
            ...
            <p style={{ fontSize: '13px', color: 'rgba(232,235,240,0.6)', lineHeight: '1.6' }}>
              RoadRight operates under <strong style={{ color: '#34D399', fontWeight: '600' }}>LSO-approved Limited Scope Retainer rules</strong> (Rule 3.2-1A).
        ...
        <div style={{ background: '#0C0F16', border: '1px solid rgba(255,255,255,0.07)', borderLeft: '3px solid #3B82F6', borderRadius: '0 14px 14px 0', padding: '20px 22px', fontSize: '15px', color: 'rgba(232,235,240,0.7)', lineHeight: '1.7', fontStyle: 'italic', marginBottom: '40px' }}>
          &ldquo;Racial profiling during traffic stops is a documented reality in Ontario. RoadRight exists so that
        ...
        <div style={{ background: 'linear-gradient(135deg, #1e3a8a, #1D4ED8)', borderRadius: '20px', padding: '32px', textAlign: 'center' as const }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '12px', alignItems: 'center', width: '100%' }}>
            ...
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)' }}>📧 <span style={{ color: 'white', fontWeight: '600' }}>info@roadright.ca</span></div>
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)' }}>🌐 <span style={{ color: 'white', fontWeight: '600' }}>roadright.ca</span></div>
          </div>
        </div>
        ...
        <div style={{ marginTop: '40px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '18px 20px' }}>
          <p style={{ fontSize: '11px', color: 'rgba(232,235,240,0.25)', lineHeight: '1.7' }}>
            <strong style={{ color: 'rgba(232,235,240,0.35)' }}>Legal Disclaimer:</strong> RoadRight is a technology platform and is not itself a law firm or legal services provider. All legal services are provided independently by LSO-licensed lawyers (L1) and paralegals (P1) who join the platform. Legal professionals are responsible for their own compliance with LSO Rules of Professional Conduct and Paralegal Rules of Conduct, including Rule 3.2-1A (Limited Scope Retainer). RoadRight does not supervise legal professionals, does not direct legal advice, and does not assume liability for services rendered. Each professional maintains their own errors and omissions insurance. RoadRight is currently in beta.
          </p>
        </div>

        {/* Footer */}
        <div style={{ marginTop: '24px', textAlign: 'center' as const, fontSize: '11px', color: 'rgba(232,235,240,0.2)', lineHeight: '1.6' }}>
          RoadRight · roadright.ca · Ontario, Canada · 2026<br />
